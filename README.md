...
### This is how to start this project

After cloning the project from the repo, run a command to install all the dependencies required in this project, if you are using npm run 'npm install' in your terminal or command line or if your using yarn run 'yarn'. After that you can now start the project server using npm start or yarn start.


### Features integrated in this project

Basically this project is targeted to having an infinite scroll feature and also a sort feature for the ascii face cards product view. Used webpack in bundling the project.